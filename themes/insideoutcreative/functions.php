...
function monroe_consulting_stylesheets() {
...
wp_enqueue_style('futura', '//use.typekit.net/val0fty.css');


}
add_action('wp_enqueue_scripts', 'monroe_consulting_stylesheets');
// for footer
function monroe_consulting_stylesheets_footer() {
...
add_action('get_footer', 'monroe_consulting_stylesheets_footer');
...
function monroe_consulting_menus() {
...
add_action('after_setup_theme', 'monroe_consulting_menus');
