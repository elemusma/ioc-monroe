...
echo '<div class="col-md-6 pr-lg-5 col-blog text-white" style="margin-bottom: 50px;">';
    ...
    if(has_post_thumbnail()){
        the_post_thumbnail('full',array('class'=>'position-absolute w-100 h-100','style'=>'top:0;left:0;'));
    } else {
        echo '<div class="position-absolute w-100 h-100 bg-accent" style="top:0;left:0;"></div>';
    }
echo '<div>';
