...
echo '<a href="' . get_the_permalink() . '" class="position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-center z-2 col-services-link overflow-h" style="top:0;left:0;opacity:0;pointer-events:none;text-decoration:none;background:var(--accent-tertiary);">';

// echo '<div class="position-relative">';
echo wp_get_attachment_image(338,'full','',['class'=>'w-100 h-100 position-absolute','style'=>'top:0;left:0;opacity:.5;object-position:top;']);
...
echo '<div class="col-12 text-center text-white pl-0">';
